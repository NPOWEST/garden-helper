...
final class ConfigCollection implements ArrayAccess, Countable, IteratorAggregate
{
     ...
     *
     * @return ArrayIterator<int|string, ConfigCollection|float|IndicatorCollection|int|string> An iterator over all config data
     */
     ...
     * @param ConfigCollection|float|IndicatorCollection|int|string $value
     *
     * @throws SetException
     */
