...
/**
 * @implements ArrayAccess<int, ArchiveCollection>
 * @implements IteratorAggregate<int, ArchiveCollection>
 */
final class ArchivesCollection implements ArrayAccess, Countable, IteratorAggregate
{
     ...
     *
     * @return ArrayIterator<int, ArchiveCollection> An iterator over all config data
     */
